...
export function getTrainingData() {
  const tweets = [
    ...
    "BUILD or fade away",
    "base ecosystem is building",
    "ship fast, build faster",
    "onchain builders only",
    "builders are the real MVPs",
    "building something that matters",
    "base frens are building",
    "cooking with build energy",
    "ship it and build more",
    "onchain or build nothing",
    "base season is building",
    "building the future, one build at a time",
    "builders know the struggle",
    "build season incoming",
    "rugs make builders stronger",
    "vibes check: building",
    "gm to the builders",
    "building something people actually want",
    "base ecosystem is building",
    "ship fast, build things",
    "onchain is the build way",
    "builders are the backbone",
    "building something that lasts",
    "base frens are building",
    "cooking with build passion",
    "ship it and build more",
    "onchain build vibes forever",
    "base season is building",
    "building something that matters",
    "builders are the real heroes",
    "build it up",
    "rugs are temporary, building is forever",
    "build vibes are unmatched",
    "gm to the real builders",
    "building in public is the way",
    "base ecosystem is building",
    "ship it and build",
    "onchain or build bust",
    "builders are the future",
    "building something that scales",
    "base frens are building",
    "cooking with build purpose",
    "ship it and build more",
    "onchain BUILD vibes only",
    "base season is BUILDING",
    "BUILDING something that matters",
    "BUILDERS are the real deal",
    "BUILD it to the moon",
    "rugs are lessons, BUILDING is forever",
    "BUILD vibes are incredible",
    "bm frens are building",
    "Bm season is here",
    "BUILD on base hits different",
    "builders on base are cooking",
    "ship fast, BUILD faster",
    "onchain BUILD vibes only",
    "BUILD or get shipped",
    "base ecosystem is BUILDING",
    "gm to the BUILDERS",
    "BUILDING something that matters",
    "base frens are BUILDING",
  ...
  switch (style.toLowerCase()) {
    case 'based':
      return allTweets.filter(tweet => 
        ...
        tweet.toLowerCase().includes('build') ||
        tweet.toLowerCase().includes('builders') ||
        tweet.toLowerCase().includes('bm') ||
        tweet.toLowerCase().includes('Bm') ||
        tweet.toLowerCase().includes('BUILD') ||

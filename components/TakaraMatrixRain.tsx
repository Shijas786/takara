        ...
        try {
          ...
          columns.forEach((column) => {
            ...
            column.symbols.forEach((symbol) => {
              ...
              const blueIntensity = Math.random() > 0.7 ? 255 : Math.random() > 0.4 ? 200 : 150
              ctx.fillStyle = `rgba(0, 0, ${blueIntensity}, ${(symbol.alpha / 255) * 0.9})`
              ctx.textAlign = 'center'
            ...
            if (Math.random() > 0.6) {
              ...
              const blueIntensity = Math.random() > 0.6 ? 255 : 200
              ctx.fillStyle = `rgba(0, 0, ${blueIntensity}, 0.6)`
              ctx.font = `${config.FONT_SIZE}px monospace`
              ctx.textAlign = 'center'

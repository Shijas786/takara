...
const wordlist = [
  ...
  'ginger', 'giraffe', 'girl', 'give', 'glad', 'glance', 'glare', 'glass', 'gleam', 'glee',
  ...
  'pave', 'payment', 'peace', 'peach', 'peanut', 'pear', 'peasant', 'pelican', 'pen', 'penalty',
  'pencil', 'people', 'pepper', 'perfect', 'permit', 'person', 'pet', 'phone', 'photo', 'phrase',
  'physical', 'picture', 'piece', 'pig', 'pigeon', 'pill', 'pilot', 'pink', 'pioneer', 'pipe',
  'pistol', 'pitch', 'pizza', 'place', 'planet', 'plastic', 'plate', 'play', 'please', 'pledge',
  'pluck', 'plug', 'plunge', 'poem', 'poet', 'point', 'polar', 'pole', 'police', 'pond',
  'pony', 'pool', 'poor', 'pop', 'popular', 'portion', 'position', 'possible', 'post', 'potato',
...
const checksum = hash[0].toString(2).padStart(8, '0').substring(0, 4);
binary += checksum;

// Convert to words
const words = [];
for (let i = 0; i < binary.length; i += 11) {
  const index = parseInt(binary.substring(i, i + 11), 2);
...
console.log('4. Use this for your Neynar app configuration');
console.log('');
console.log('⚠️  IMPORTANT: Keep this mnemonic secure and private!');
console.log('   Store it safely - it controls your app signer!'); 